...
def ensure_config_has_keys(cfg: dict):
    ...
    if not cfg["imap"]["email_user"] or not cfg["imap"]["email_pass"]:
        raise ValueError("Credenziali IMAP mancanti. Imposta READI_IMAP_USER e READI_IMAP_PASS.")
...
# =========================
model = {d: {"state": "A_TERRA", "last_event_text": "—", "timer_start_dt": None} for d in display_order}
